<template>
  <header>
    ...
    <ul>
      ...
      <li>
        <router-link to="/aboutUs">aboutUs不需要登陆</router-link>
      </li>
      <li>
        <router-link to="/virtualkeyboard">virtualkeyboard不需要登陆</router-link>
      </li>
      <li v-if="loginBtnShow">
        <a @click="signOutFun()">Sign out</a>
      </li>
      <br>
    </ul>
  </header>
